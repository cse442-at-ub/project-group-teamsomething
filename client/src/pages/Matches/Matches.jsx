            ...
            <Grid item xs={10}>
              ...
              <div className="flex flex-col">
                ...
                <Typography variant="body1" style={{ marginRight: '0px' }}>
                  I'm an active enthusiast with a passion for fitness that extends beyond the gym. When I'm not breaking a sweat, you can often find me exploring vibrant hiking trails, challenging myself to conquer new peaks, or enjoying serene yoga sessions in the great outdoors. I relish in organizing group fitness activities with my friends, whether it's a weekend hike ...
                </Typography>
