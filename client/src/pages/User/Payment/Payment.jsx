...
const btnStyle =
  "bg-[#E8E9F4] font-bold py-3 px-4 rounded-xl text-lg flex items-center justify-center shadow-md";
      ...
      >
        <Box p={3} flex={1}>
          ...
          <Typography mb={2} variant="body1">
            Current Balance: <span className="font-bold">$30</span>
          </Typography>
