        ...
        <Stack p={5} maxWidth={800} spacing={2}>
            ...
            <form onSubmit={handleSubmit}>
                <Stack spacing={2}>
                    ...
                    <Stack spacing={1}>
                        <Typography component={'label'} htmlFor="new-password" fontWeight='600'>
                            New Password
                        </Typography>
                        <TextField
                            variant="outlined"
                    ...
                    <Stack spacing={1}>
                        <Typography component={'label'} htmlFor="confirm-new-password" fontWeight='600'>
                    ...
                    {error && <Typography color='error' sx={{alignSelf: 'flex-end'}}>{error}</Typography>}
                </Stack>
            </form>
        </Stack>
    )
